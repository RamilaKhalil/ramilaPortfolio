...
function createStarGeometry(radius1, radius2, points) {
    ...
    for (let i = 0; i < points; i++) {
      ...
      const angle2 = angle + angleStep / 2;
...
function Geometries() {
    const geometries = [
        ...
        {
            position: [1, -0.75, 5],
           r: 0.4, // Adjusted size for the star
        geometry: createStarGeometry(1, 0.4, 5), // Star with small size
        },
        {
         position: [1, -0.65, 2],
         r: 0.4,
  ...
  const materials = [
    ...
    new THREE.MeshStandardMaterial({ color: 0x8e44ad, roughness: 0.5 }),
